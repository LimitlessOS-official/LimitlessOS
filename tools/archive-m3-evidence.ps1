...
$evidenceDir = Join-Path $distDir "m3-evidence-$timestamp"
...
function Get-InventoryPath
{
    ...
    return Join-Path $distDir "limitlessos-x86_64.$suffix.m3.json"
}
...
$metadata = [ordered]@{
    milestone = "M3 Product Boot Contract + Network Promotion"
...
$metadataPath = Join-Path $evidenceDir "m3-evidence.json"
$metadata | ConvertTo-Json -Depth 8 | Set-Content -LiteralPath $metadataPath -Encoding UTF8

Write-Host "M3 evidence archived:"
