...
function Assert-RuntimeShellSurfaceSource
{
    ...
    foreach ($requiredText in @(
        ...
        "Product services: BIOS fallback shows service and session status; installer UX unavailable",
        ...
        "Product cloud storage: Settings and File Manager show broker policy; sync unavailable; transfers denied",
        ...
        "Identity, account, vault, and transport status: Settings; local only; no secret storage",
        ...
        "Installer UX: unavailable on BIOS checksum fallback; validation tools only",
