...
elseif ($BootMedia -eq "disk") {
    ...
    Assert-OutputContains -Lines $outputLines -Pattern 'Product network: net shows DHCP lease; net curl example\.com performs a scoped HTTP GET' -Message "x64 ring-3 shell stream Product network help output was not observed."
