...
Assert-Line -Lines $lines -Pattern '^install authority: disabled in M[89]; scoped capability required$' -Message "M8 package UX verifier failed: install authority status was not visible."
Assert-Line -Lines $lines -Pattern '^update-apply authority: disabled in M[89]; scoped install required$' -Message "M8 package UX verifier failed: update-apply authority status was not visible."
