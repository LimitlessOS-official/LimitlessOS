...
static void display64_desktop_draw_file_manager(u32 handle)
{
    ...
    (void)display64_draw_font_text(body_x + 116u, body_y + 60u, "Sync unavailable", DISPLAY64_FONT_NORMAL, DISPLAY64_RGB_DISABLED_TEXT, DISPLAY64_FONT_TRANSPARENT);
#endif
#if defined(LIMITLESS_X64_UEFI_KERNEL) && LIMITLESS_X64_UEFI_KERNEL
    cloud_storage64_init();
...
static void display64_desktop_draw_settings(u32 handle)
{
    ...
    (void)display64_draw_font_text(body_x, body_y + 438u, "Consent host; inference unavailable", DISPLAY64_FONT_NORMAL, DISPLAY64_RGB_TEXT_SECONDARY, DISPLAY64_FONT_TRANSPARENT);
...
static void display64_desktop_draw_assistant(u32 handle)
{
    ...
    (void)display64_draw_font_text(body_x, body_y + 20u, "Consent-scoped action templates", DISPLAY64_FONT_NORMAL, DISPLAY64_RGB_TEXT_SECONDARY, DISPLAY64_FONT_TRANSPARENT);
    ...
    (void)display64_draw_font_text(body_x, body_y + 140u, "Generated replies unavailable", DISPLAY64_FONT_NORMAL, DISPLAY64_RGB_TEXT_SECONDARY, DISPLAY64_FONT_TRANSPARENT);
