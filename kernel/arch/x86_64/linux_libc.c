...
static const linux_libc64_export_t g_linux_libc64_exports[LINUX_LIBC64_SYMBOL_COUNT] = {
    ...
    { "getcwd", 6u, LINUX_LIBC64_RVA_GETCWD, LINUX_LIBC64_KIND_SYSCALL, LINUX_ABI64_SYSCALL_GETCWD },
    { "chdir", 5u, LINUX_LIBC64_RVA_CHDIR, LINUX_LIBC64_KIND_SYSCALL, LINUX_ABI64_SYSCALL_CHDIR },
    { "write", 5u, LINUX_LIBC64_RVA_WRITE, LINUX_LIBC64_KIND_SYSCALL, LINUX_ABI64_SYSCALL_WRITE },
    { "readlink", 8u, LINUX_LIBC64_RVA_READLINK, LINUX_LIBC64_KIND_SYSCALL, LINUX_ABI64_SYSCALL_READLINK },
    ...
    { "fcntl", 5u, LINUX_LIBC64_RVA_FCNTL, LINUX_LIBC64_KIND_SYSCALL, LINUX_ABI64_SYSCALL_FCNTL },
    ...
    { "dup", 3u, LINUX_LIBC64_RVA_DUP, LINUX_LIBC64_KIND_SYSCALL, LINUX_ABI64_SYSCALL_DUP },
...
static void linux_libc64_write_syscall_stub(u32 rva, u32 syscall_number)
{
    ...
    if ((rva < LINUX_LIBC64_TEXT_RVA)
        || ((offset + 8u) > (LINUX_LIBC64_TEXT_FILE_OFFSET + LINUX_LIBC64_TEXT_FILE_BYTES + LINUX_LIBC64_RODATA_FILE_BYTES)))
    {
        return;
    }
