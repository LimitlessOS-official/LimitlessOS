...
static void log_pci_storage_surface(void)
{
    ...
    write_string(" vmd-nested-pci ");
    write_hex_u32(pci64_vmd_nested_first_address(cap, owner));
    write_string(" vmd-nested-vendor-device ");
    write_hex_u32(pci64_vmd_nested_first_vendor_device(cap, owner));
    write_string(" vmd-nested-class ");
    write_hex_u32(pci64_vmd_nested_first_class(cap, owner));
    write_string(" vmd-nested-bar0 ");
    ...
    write_string(" vmd-nested-mmio-low ");
    write_hex_u32(pci64_vmd_nested_mmio_base_low(cap, owner));
    write_string(" vmd-nested-mmio-high ");
    write_hex_u32(pci64_vmd_nested_mmio_base_high(cap, owner));
    write_string(" vmd-nested-mmio-span ");
    write_dec_u32(pci64_vmd_nested_mmio_span_hint(cap, owner));
    write_string(" vmd-nested-mmio-flags ");
    write_hex_u32(pci64_vmd_nested_mmio_flags(cap, owner));
    write_string(" vmd-nested-mmio-token ");
    write_hex_u32(pci64_vmd_nested_mmio_token(cap, owner));
    write_string(" vmd-nested-bind-ready ");
    write_dec_u32(pci64_vmd_nested_bind_ready(cap, owner));
    write_string(" vmd-nested-bind-status ");
