...
#define LINUX_ABI64_EXIT_RECORD_LIMIT 32u
#define LINUX_ABI64_RLIMIT_RECORD_LIMIT 32u
#define LINUX_ABI64_FUTEX_WAITER_LIMIT 32u
#define LINUX_ABI64_CLONE_RECORD_LIMIT 16u
#else
#define LINUX_ABI64_EXIT_RECORD_LIMIT 16u
#define LINUX_ABI64_RLIMIT_RECORD_LIMIT 16u
#define LINUX_ABI64_FUTEX_WAITER_LIMIT 4u
#define LINUX_ABI64_CLONE_RECORD_LIMIT 4u
#endif
...
#if defined(LIMITLESS_X64_UEFI_KERNEL) && LIMITLESS_X64_UEFI_KERNEL
#define LINUX_ABI64_MMAP_FILE_COPY_BYTES 65536u
#define LINUX_ABI64_MMAP_FILE_WINDOW_BYTES 4096u
#endif
