...
enum
{
    ...
    RAMFS_NODE_APPS = 4u,
    RAMFS_NODE_HELLO = 5u,
    RAMFS_NODE_ECHO_APP = 6u,
    RAMFS_NODE_LS_APP = 7u,
    RAMFS_NODE_CAT_APP = 8u,
    RAMFS_NODE_STAT_APP = 9u,
    RAMFS_NODE_MKDIR_APP = 10u,
    RAMFS_NODE_WRITE_APP = 11u,
    RAMFS_NODE_RENAME_APP = 12u,
    RAMFS_NODE_MOVE_APP = 13u,
    RAMFS_NODE_APPEND_APP = 14u,
    RAMFS_NODE_DELETE_APP = 15u,
    RAMFS_NODE_SAY_APP = 16u,
    RAMFS_NODE_SHOW_APP = 17u,
    RAMFS_NODE_LIST_APP = 18u,
    RAMFS_NODE_MAKE_APP = 19u,
    RAMFS_NODE_PUT_APP = 20u,
    RAMFS_NODE_SWAP_APP = 21u,
    RAMFS_NODE_SHIFT_APP = 22u,
    RAMFS_NODE_ASK_APP = 23u,
    RAMFS_NODE_TOUCH_APP = 24u,
    RAMFS_NODE_COPY_APP = 25u,
    RAMFS_NODE_APPS_INDEX = 26u,
