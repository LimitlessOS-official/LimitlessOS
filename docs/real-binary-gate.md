...
Proposed M80 scope: apply and read back only the five M79 apply-ready relocations, keep the unavailable startup relocation blocked, and still deny before dynamic control transfer.
