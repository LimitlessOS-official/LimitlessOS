...
Proposed M105 scope: trace and prove dynamic pipe close/error semantics, especially EOF after all write ends close, `SIGPIPE`/`EPIPE` after all read ends close, and cleanup of blocked tasks and pipe objects across those close/error paths.
